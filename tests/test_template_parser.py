...
{'test_template.xlsx': {'checksum': '072ef2684161f84c7f86c1545f99ca2c',
                        'data': {'Another Sheet': {'A10': {'cellref': 'A10',
                                                           'data_type': 'TEXT',
                                                           'file_name': '/home/lemon/code/python/bcompiler-engine/tests/resources/test_template.xlsx',
...
Test lxml reader - output must match this ^
"""
